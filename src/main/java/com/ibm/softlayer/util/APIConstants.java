...
public class APIConstants {
	...
	/** The Constant GETUPDATES_API. */
	public static final String GETUPDATES_API = "getUpdates";
	
	/** The Constant GET_OPEN_TICKETS. */
	public static final String GET_OPEN_TICKETS = "getOpenTickets";
	
	/** The Constant GET_CLOSED_TICKETS. */
	public static final String GET_CLOSED_TICKETS = "getClosedTickets";

	/** The Constant GET_TICKETS. */
	public static final String GET_TICKETS = "getTickets";
	
	/** The Constant ACCOUNT_ROOT_API. */
	...
	public static final String GET_VIRTUAL_GUESTS_API = "getVirtualGuests";
